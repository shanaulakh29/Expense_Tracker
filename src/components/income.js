...
function Income(){
  ...
  return (
    ...
    <div className="text-white  text-md md:text-xl p-2 rounded-lg shadow-2xl w-3/4 lg:bg-green-600  ">
      <div>Total Income <span className="hidden lg:inline">Till Date</span></div>
