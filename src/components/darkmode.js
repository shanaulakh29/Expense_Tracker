...
function Darkmode (){
  ...
  return (
    <div className="flex items-center mr-8  w-16">
      ...
      <input type="checkbox" checked={ischecked} className={`w-6 h- rounded-full relative  appearance-none border bg-green-500`} onClick={handleclick}></input> 
       </div>
    </div>
  )
}
